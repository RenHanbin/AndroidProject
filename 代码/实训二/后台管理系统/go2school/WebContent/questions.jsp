			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-5 col-8 align-self-center">
						<h3 class="text-themecolor m-b-0 m-t-0">问题管理</h3>
						<ol class="breadcrumb">
					...
					<div class="col-md-7 col-4 align-self-center">
						<form action="${path}/question/getLikeQuestionList" method="post" align="right">
							<input id="search" type="text" name="searchstr" class="username" placeholder="搜索" size="20">
							<button type="submit" class="btn waves-effect waves-light btn-warning hidden-md-down">搜索</button> 
						</form>
					</div>
				</div>
				<!-- ============================================================== -->
							...
							<div class="card-block">
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											<c:if test="${remark=='getQuestionList' }">
											<c:forEach items="${questionList}" var="question" varStatus="status"> 
											
												<tr>
													<td>${ status.index + 1}</td>
													<td>${question.questionTitle}</td>
													<td><a href="${path}/question/deleteQuestion?questionId=${question.questionId}&&remark1=all" class="btn waves-effect waves-light btn-warning hidden-md-down">删除</a></td>
												</tr>
											</c:forEach>
											</c:if>
											<c:if test="${remark=='getLikeQuestionList' }">
											<c:forEach items="${questionListLike}" var="question" varStatus="status"> 
											
												<tr>
													<td>${ status.index + 1}</td>
													<td>${question.questionTitle}</td>
													<td><a href="${path}/question/deleteQuestion?questionId=${question.questionId}&&remark1=like" class="btn waves-effect waves-light btn-warning hidden-md-down">删除</a></td>
												</tr>
											</c:forEach>
											</c:if>
										</tbody>
