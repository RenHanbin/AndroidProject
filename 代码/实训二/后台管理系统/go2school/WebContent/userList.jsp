		...
		<header class="topbar">
			<nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
				...
				<div class="navbar-header">
					<a class="navbar-brand" href="${path}/index.jsp"> <!-- Logo icon -->
						...
						<span> <!-- Light Logo text --> <img
							src="${path}/assets/images/logo-light-text.png" class="light-logo"
							alt="homepage" /></span>
					</a>
				</div>
				<!-- ============================================================== -->
										...
										<tbody>
											<c:forEach items="${users}" var="user">
												<tr>
													...
													<td>${user.userTel}</td>
													<td><a href="${path }/user/findUserById?userId=${user.userId}" class="link">
                                        			<i class="icon-people"></i> 
                                        			<font class="font-medium">详细信息</font>
                                        </a></td>
												</tr>
											</c:forEach>
										</tbody>
