			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-5 col-8 align-self-center">
						<h3 class="text-themecolor m-b-0 m-t-0">文章管理</h3>
						<ol class="breadcrumb">
					...
					<div class="col-md-7 col-4 align-self-center">
						<form action="${path}/article/getLikeArticleList" method="post" align="right">
						...
						<!-- <a href="${path}/question/getLikeQuestionList?searchstr=$('input[name=searchstr]').val()"
							...
							<div class="card-block">
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											<c:if test="${remark=='getArticleList' }">
												<c:forEach items="${articleList}" var="article"
													...
													<tr>
														...
														<td><a
															href="${path}/article/deleteArticle?articleId=${article.articleId}&&remark1=all"
															class="btn waves-effect waves-light btn-warning hidden-md-down">删除</a></td>
													</tr>
												</c:forEach>
											</c:if>
											<c:if test="${remark=='getLikeArticleList' }">
												<c:forEach items="${articleListLike}" var="article"
													varStatus="status">
													...
													<tr>
														...
														<td>${article.articleTitle}</td>
														<td><a
															href="${path}/article/deleteArticle?articleId=${article.articleId}&&remark1=like"
															class="btn waves-effect waves-light btn-warning hidden-md-down">删除</a></td>
													</tr>
												</c:forEach>
											</c:if>
