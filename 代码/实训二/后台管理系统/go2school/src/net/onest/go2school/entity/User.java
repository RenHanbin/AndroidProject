...
public class User {
    ...
    private int userFans;//拥有的粉丝数
    private int userAtten;//关注的用户数
    public User(){
        userSex="男";
        userEmail=" ";
    ...
    public User(int userId,double userBalance, String userName, String userPassword, String userEmail, String userTel, String userSex) {
        this.userId = userId;
