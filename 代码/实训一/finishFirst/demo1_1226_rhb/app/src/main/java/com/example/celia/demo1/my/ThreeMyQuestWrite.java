...
import com.example.celia.demo1.shequ.ThreeMyCommWrite;
...
public class ThreeMyQuestWrite extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        error.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(ThreeMyQuestWrite.this,MyQuest.class);
    ...
    private class AddQuestionAsyncTask extends AsyncTask<String,Void,Boolean> {
        ...
        protected Boolean doInBackground(String... strings) {
            ...
            String urlStr=path+"QuestionServlet?remark=addQuestion&questionTitle="+questionTitle+"&questionDiscribe="+questionDiscribe+"&userId="+userId;
            try {
