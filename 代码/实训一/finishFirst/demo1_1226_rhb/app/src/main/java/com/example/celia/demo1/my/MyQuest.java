...
public class MyQuest extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Ireturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(MyQuest.this, TabHostActivity.class);
        ...
        //去提问
        LinearLayout quTiWen=findViewById(R.id.ll_qutiwen);
        quTiWen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(MyQuest.this,ThreeMyQuestWrite.class);
        ...
        listQuest.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent1.setClass(MyQuest.this,Index3MyQuestItem.class);
                intent1.putExtra("questionId",datalist.get(position).getQuestionId());
                intent1.putExtra("questionTitle",datalist.get(position).getQuestionTitle());
                Log.e("questionTitle",datalist.get(position).getQuestionTitle());
                intent1.putExtra("questionDiscribe",datalist.get(position).getQuestionDiscribe());
                intent1.putExtra("attenNum",datalist.get(position).getUserCount()+"");
                intent1.putExtra("commNum",datalist.get(position).getCommNum()+"");
                Log.e("intent11",intent1.toString());
    ...
    class GetMyQuestListAsyncTask extends AsyncTask<String,Void,List<Question>>{
        ...
        protected List<Question> doInBackground(String... strings) {
            ...
            String urlStr = path+"MyQuestionServlet?remark=getMyQuestionList&userId="+userId;
            try {
