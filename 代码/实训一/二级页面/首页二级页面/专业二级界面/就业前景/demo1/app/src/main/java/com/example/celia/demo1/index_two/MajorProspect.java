...
import com.example.celia.demo1.my.Major;
...
public class MajorProspect extends AppCompatActivity{
    ...
    class GetMajorListAsyncTask extends AsyncTask<String,Void,List<Major>>{
        ...
        public GetMajorListAsyncTask(Context mContext,ListView listView){
            this.mContext=mContext;
            this.listView=listView;
        }
        @Override
        protected List<Major> doInBackground(String... strings) {
            String urlStr = "http://192.168.1.102:8080/go2school/MajorServlet?remark=getMajorList";
            try {
