...
import com.example.celia.demo1.index_two.MajorHot;
import com.example.celia.demo1.index_two.MajorProspect;
    ...
    private class IndexListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.iv_job:{
                    Log.e("test","就业前景");
                    Intent intentToProspect = new Intent(getActivity(),MajorProspect.class);
                    startActivity(intentToProspect);
                    break;
                }
                case R.id.iv_hot:{
                    Log.e("test","热门专业");
                    Intent intentToHot = new Intent(getActivity(),MajorHot.class);
                    startActivity(intentToHot);
                    break;
                }
                case R.id.iv_school:{
                    Log.e("test","大学介绍");
