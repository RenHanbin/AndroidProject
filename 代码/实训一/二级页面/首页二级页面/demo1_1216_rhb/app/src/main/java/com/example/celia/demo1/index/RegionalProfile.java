...
public class RegionalProfile extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        city.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                GetSchoolListAsyncTask asyncTask1 = new GetSchoolListAsyncTask(RegionalProfile.this,profileListView);
                asyncTask1.execute();
            }
        ...
        ivreturn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(
                        RegionalProfile.this,TabHostActivity.class);
    ...
    //筛选
    class GetSchoolListAsyncTask extends AsyncTask<String,Void,List<ProfileBean>> {
        ...
        @Override
        protected List<ProfileBean> doInBackground(String... strings) {
            String cityName = (String) textView.getText();
            Log.e("cityName",cityName);
            String path = getResources().getString(R.string.url_path);
            String urlStr = path+"CityServlet?remark=getSchoolNameByCity&cityName="+cityName;
            try {
                URL url = new URL(urlStr);
                HttpURLConnection connection = (HttpURLConnection) url.openConnection();
                connection.setRequestProperty("contentType", "utf-8");//解决给服务器端传输的乱码问题
                ...
                for (int i = 0; i < array.length(); ++i) {
                    JSONObject object1 = array.getJSONObject(i);
                    ProfileBean school = new ProfileBean();
                    school.setSchoolName(object1.getString("schoolName"));
                    school.setSchoolRank(object1.getInt("schoolRank"));
                    school.setSchoolBestMajor(object1.getString("schoolBestMajor"));
                    profileList.add(school);
                }
                Log.e("test", profileList.toString());
                return profileList;
            } catch (MalformedURLException e) {
