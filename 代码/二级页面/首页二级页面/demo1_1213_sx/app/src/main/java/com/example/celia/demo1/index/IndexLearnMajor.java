    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        iv_return.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(IndexLearnMajor.this, IndexLearn.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent();
                intent.setClass(IndexLearnMajor.this,Index_major.class);
                intent.putExtra("majorName",majorList.get(position).getMajorName());
                intent.putExtra("mainMajor",majorList.get(position).getMajorTypeName());
                intent.putExtra("info",majorList.get(position).getMajorIntroduce());
                intent.putExtra("subject",majorList.get(position).getMajorSubject());
                intent.putExtra("derections",majorList.get(position).getMajorWork());
                startActivity(intent);
            }
        });
    }
